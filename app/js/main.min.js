...
$(function(){const s=document.querySelector(".contact__form-textarea");s.addEventListener("input",()=>{0<s.scrollTop?s.style.height=s.scrollHeight+"px":s.style.height="auto"}),$(".team__slider-inner").slick({arrows:!1,slidesToShow:3.5,infinite:!1}),$(".testimonials__slider-inner").slick({arrows:!1,draggable:!1}),$(".testimonials__prev").on("click",function(s){s.preventDefault(),$(".testimonials__slider-inner").slick("slickPrev")}),$(".testimonials__next").on("click",function(s){s.preventDefault(),$(".testimonials__slider-inner").slick("slickNext")}),$(".blog__tab").on("click",function(s){s.preventDefault(),$(".blog__tab").removeClass("blog__tab--active"),$(".blog__item").removeClass("blog__item--show"),$(this).addClass("blog__tab--active"),$($(this).attr("href")).addClass("blog__item--show")}),$(".services__tab-link").on("click",function(s){s.preventDefault(),$(".services__tab-link").removeClass("services__tab-link--active"),$(".services__image").removeClass("services__image--show"),$(this).addClass("services__tab-link--active"),$($(this).attr("href")).addClass("services__image--show")});var o={aConts:[],mouseY:0,N:0,asd:0,sc:0,sp:0,to:0,scrollbar:function(s){var t=document.getElementById(s);if(!o.init())return!1;s=t.cloneNode(!1);return s.style.overflow="hidden",t.parentNode.appendChild(s),s.appendChild(t),t.style.position="absolute",t.style.left=t.style.top="0px",t.style.width="calc(100% + 50px)",t.style.height="100%",(o.aConts[o.N++]=t).sg=!1,t.st=this.create_div("ssb_st",t,s),t.sb=this.create_div("ssb_sb",t,s),t.su=this.create_div("ssb_up",t,s),t.sd=this.create_div("ssb_down",t,s),t.sb.onmousedown=function(s){return this.cont.sg||(s=s||window.event,o.asd=this.cont,this.cont.yZ=s.screenY,this.cont.sZ=t.scrollTop,this.cont.sg=!0,this.className="ssb_sb ssb_sb_down"),!1},t.st.onmousedown=function(s){s=s||window.event,o.asd=this.cont,o.mouseY=s.clientY+document.body.scrollTop+document.documentElement.scrollTop;for(var t=this.cont,e=0;null!=t;t=t.offsetParent)e+=t.offsetTop;this.cont.scrollTop=(o.mouseY-e-this.cont.ratio*this.cont.offsetHeight/2-this.cont.sw)/this.cont.ratio,this.cont.sb.onmousedown(s)},t.su.onmousedown=t.su.ondblclick=function(s){return o.mousedown(this,-1),!1},t.sd.onmousedown=t.sd.ondblclick=function(s){return o.mousedown(this,1),!1},t.su.onmouseout=t.su.onmouseup=o.clear,t.sd.onmouseout=t.sd.onmouseup=o.clear,t.sb.onmouseover=function(s){return this.cont.sg||(this.className="ssb_sb ssb_sb_over"),!1},t.sb.onmouseout=function(s){return this.cont.sg||(this.className="ssb_sb"),!1},t.ssb_onscroll=function(){this.ratio=(this.offsetHeight-2*this.sw)/this.scrollHeight,this.sb.style.top=Math.floor(this.sw+this.scrollTop*this.ratio)+"px"},t.sw=2,t.ssb_onscroll(),o.refresh(),t.onscroll=t.ssb_onscroll,t},init:function(){return!(window.oper||!window.addEventListener&&!window.attachEvent)&&(s(window.document,"mousemove",o.onmousemove),s(window.document,"mouseup",o.onmouseup),s(window,"resize",o.refresh),!0);function s(s,t,e){return window.addEventListener?(s.addEventListener(t,e,!1),o.w3c=!0):window.attachEvent&&s.attachEvent("on"+t,e)}},create_div:function(s,t,e){var o=document.createElement("div");return o.cont=t,o.className=s,e.appendChild(o),o},clear:function(){return clearTimeout(o.to),o.sc=0,!1},refresh:function(){for(var s=0,t=o.N;s<t;s++){var e=o.aConts[s];e.ssb_onscroll(),e.sb.style.width=e.st.style.width=e.su.style.width=e.su.style.height=e.sd.style.width=e.sd.style.height=e.sw+"px",e.sb.style.height=Math.ceil(Math.max(.5*e.sw,e.ratio*e.offsetHeight)+1)+"px"}},arrow_scroll:function(){0!=o.sc&&(o.asd.scrollTop+=6*o.sc/o.asd.ratio,o.to=setTimeout(o.arrow_scroll,o.sp),o.sp=32)},mousedown:function(s,t){0==o.sc&&(s.cont.sb.className="ssb_sb ssb_sb_down",o.asd=s.cont,o.sc=t,o.sp=400,o.arrow_scroll())},onmousemove:function(s){s=s||window.event,o.mouseY=s.screenY,o.asd.sg&&(o.asd.scrollTop=o.asd.sZ+(o.mouseY-o.asd.yZ)/o.asd.ratio)},onmouseup:function(s){s=(s=s||window.event).target||s.srcElement;o.asd&&document.releaseCapture&&o.asd.releaseCapture(),o.asd&&(o.asd.sb.className=0<s.className.indexOf("scrollbar")?"ssb_sb ssb_sb_over":"ssb_sb"),document.onselectstart="",o.clear(),o.asd.sg=!1}};window.onload=function(){o.scrollbar("container")}});