...
$(function(){$(".menu a, .logo, .contact-block__btn, .footer__list a").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},800)});const e=document.querySelector(".contact__form-textarea");e.addEventListener("input",()=>{0<e.scrollTop?e.style.height=e.scrollHeight+"px":e.style.height="auto"}),$(".services__tab-link").on("click",function(e){e.preventDefault(),$(".services__tab-link").removeClass("services__tab-link--active"),$(".services__image").removeClass("services__image--show"),$(this).addClass("services__tab-link--active"),$($(this).attr("href")).addClass("services__image--show")}),$(".blog__tab").on("click",function(e){e.preventDefault(),$(".blog__tab").removeClass("blog__tab--active"),$(".blog__item").removeClass("blog__item--show"),$(this).addClass("blog__tab--active"),$($(this).attr("href")).addClass("blog__item--show")}),$(".testimonials__slider-inner").slick({arrows:!1,draggable:!1}),$(".testimonials__prev").on("click",function(e){e.preventDefault(),$(".testimonials__slider-inner").slick("slickPrev")}),$(".testimonials__next").on("click",function(e){e.preventDefault(),$(".testimonials__slider-inner").slick("slickNext")}),$(".team__slider-inner").slick({arrows:!1,slidesToShow:3.5,infinite:!1,responsive:[{breakpoint:992,settings:{slidesToShow:2.5}},{breakpoint:700,settings:{slidesToShow:2,dots:!0}},{breakpoint:450,settings:{slidesToShow:1,dots:!0}}]}),setInterval(()=>{50<$(document).scrollTop()&&!1===$(".header__top-inner").hasClass("header__top-inner--open")?$(".burger-btn").addClass("burger-btn--follow"):$(".burger-btn").removeClass("burger-btn--follow")},0),$(".burger-btn, .header__top-inner a, .overlay").on("click",function(e){e.preventDefault(),$(".header__top-inner").toggleClass("header__top-inner--open"),$(".overlay").toggleClass("overlay--show"),$(".burger-btn").removeClass("burger-btn--follow"),$(".burger-btn").toggleClass("burger-btn--cross"),50<$(document).scrollTop()&&$(".header__top-inner").hasClass("header__top-inner--open")&&$(".burger-btn").addClass("burger-btn--follow")})});