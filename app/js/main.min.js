...
$(function(){const e=document.querySelector(".contact__form-textarea");e.addEventListener("input",()=>{0<e.scrollTop?e.style.height=e.scrollHeight+"px":e.style.height="auto"}),$(".team__slider-inner").slick({arrows:!1,slidesToShow:3,infinite:!1,variableWidth:!0}),$(".testimonials__slider-inner").slick({arrows:!1,draggable:!1}),$(".testimonials__prev").on("click",function(e){e.preventDefault(),$(".testimonials__slider-inner").slick("slickPrev")}),$(".testimonials__next").on("click",function(e){e.preventDefault(),$(".testimonials__slider-inner").slick("slickNext")}),$(".blog__tab").on("click",function(e){e.preventDefault(),$(".blog__tab").removeClass("blog__tab--active"),$(".blog__item").removeClass("blog__item--show"),$(this).addClass("blog__tab--active"),$($(this).attr("href")).addClass("blog__item--show")}),$(".services__tab-link").on("click",function(e){e.preventDefault(),$(".services__tab-link").removeClass("services__tab-link--active"),$(".services__image").removeClass("services__image--show"),$(this).addClass("services__tab-link--active"),$($(this).attr("href")).addClass("services__image--show")})});